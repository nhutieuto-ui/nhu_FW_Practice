...
Call log:
  ...
  - waiting for locator('.order-status')
    14 × locator resolved to <span class="order-status confirmed">Đã xác nhận</span>
       - unexpected value "Đã xác nhận"
